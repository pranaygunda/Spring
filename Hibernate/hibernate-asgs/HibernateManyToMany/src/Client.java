...
public class Client {
	...
	public static void main(String args[]) {
		try
		{
			...
			Student hem = new Student(259, "Mohammed Taqueeuddin");
			Student gsp = new Student(224, "Gunda Pranay");
			Student cjr = new Student(208, "Harshitha Maripally");
			Student msr = new Student(232, "Sachin Reddy");
